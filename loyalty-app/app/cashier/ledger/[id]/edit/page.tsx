...
export default async function EditLedgerCustomerPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = await params;
  const { profile, branch } = await requireCashierManagerPageSession(`/cashier/ledger/${id}/edit`);
